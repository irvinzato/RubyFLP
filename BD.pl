...
movie(anna, 1987).
movie(harry_potter, 2005).
movie(jdhsj, 2547).
movie(reino_prohibido, 2008).
...
director(betty_boop, jacqui).
director(la_llorona, betty).
director(it, stifen_quing).
director(untitled_woody_allen_fall_project_betty_2019, mackinney).
director(cincuenta_sombrras_de_esteban, jackelinsky).
director(yo_soy_gellman, yanet).
director(el_verdadero_amor_de_german, su_amorcito_corazon).
director(jdhsj, esteban).
director(reino_prohibido, _).
